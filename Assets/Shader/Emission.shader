Shader "LearnShader/Emission"
{
    Properties
    {
        ...
        _Emission1("Emmisive Color1", Color) = (0,0,0,0)                    // 发光颜色
        _EmissionColorTimes1("EmissionColorTimes1", float) = 1              // 发光颜色倍数

        _Emission2("Emmisive Color2", Color) = (0,0,0,0)                    // 光晕的发光颜色
        _EmissionColorTimes2("EmissionColorTimes2", float) = 1              // 光晕的发光颜色倍
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            sampler2D _MainTex;  
            //因为没有用到UV运算，也就是TRANSFORMTEX这个函数
            //所以，没有定义_MainTex_ST
